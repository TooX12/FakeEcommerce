...
import { PRODUCTOS_HOMBRE } from "../app/utils/apiLinks";
import { filtros } from "../app/utils/filtros";
import { ordenar } from "../app/utils/ordenar";
import { Api } from "./api/api";

function HombrePagina({ productos }: { productos: Producto[] }) {
    ...
    <>
      ...
      <section className="bg-slate-50 max-w-12xl mx-auto">
        <div className="w-full h-64 lg:h-80 relative flex flex-col justify-center items-center mb-8 md:mb-10">
          <img
            src="https://images.unsplash.com/photo-1471119017026-179f1bb0a70e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1137&q=80"
            alt="hombre.jpg"
...
export default HombrePagina;

export const getStaticProps: GetStaticProps = async () => {
  const productos = await Api.getResources(PRODUCTOS_HOMBRE);
