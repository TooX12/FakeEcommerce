...
import { ProductoFormikValues } from "../app/ts/producto.interface";
...
function AgregarProducto() {
  ...
  const handleSubmit = async (values: ProductoFormikValues) => {
    const response = await Api.createResource(PRODUCTOS, values);
  ...
  return (
    <>
    <HeadComponent title="Agregar Producto" />
      <DashboardLayout>
