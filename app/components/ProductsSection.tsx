...
function ProductsSection({ productos }: { productos: Producto[] }) {
  ...
  return (
    //     <section className="max-w-12xl mx-auto bg-slate-50">
    //       <div className="w-full relative flex flex-col py-3 sm:py-6 px-5">
    //         <h2 className="text-lg sm:text-2xl lg:text-4xl pl-5 font-bold mb-5 lg:mb-16 mt-3 lg:mt-5 text-slate-600">
              ...
              <Menu as="div" className="relative inline-block text-left">
                <div>
                  <Menu.Button className="group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900">
                    Filtrar
                    <i className="bx bx-chevron-down flex-shrink-0 -mr-1 ml-1 text-base text-gray-400 group-hover:text-gray-500 " aria-hidden="true"></i>
                  </Menu.Button>
                </div>
                      ...
                      <>
                        <h3 className="-my-3 flow-root">
                          <Disclosure.Button className="py-3 bg-slate-50 w-full flex items-center justify-between text-sm text-gray-400 hover:text-gray-500">
                            ...
                            <span className="ml-6 flex items-center" aria-hidden="true">
                              {open ? (
                                // <MinusSmIcon className="h-5 w-5" aria-hidden="true" />
                                <i className="bx bx-minus text-base" aria-hidden="true"></i>
                                
                              ) : (
                                // <PlusSmIcon className="h-5 w-5" aria-hidden="true" />
                                <i className="bx bx-plus text-base" aria-hidden="true"></i>
                              )}
                            </span>
                          </Disclosure.Button>
                        </h3>
